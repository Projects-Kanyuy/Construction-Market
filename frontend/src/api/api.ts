...
export const fetchCompanyById = (id: string | number) =>
  instance.get(`/companies/by_id/${id}`);
// export const fetchCompanies = (lat: number, lon: number) => instance.get('/companies/by_location', { params: { lat, lon } });

export const getCompanyByUsername = (username: string) =>
  instance.get(`/companies/${username}`);

export const getCompaniesByCategory = (categoryId: string | number) =>
  instance.get(`/companies/category/${categoryId}`);
export const getProjectsByCompany = (companyUsername: string) =>
  instance.get(`/companies/${companyUsername}/projects`);

export const getFeaturedCompanies = () =>
  instance.get("/companies/view-count/featured");
...
export const incrementCompanyViewCount = (companyId: string | number) =>
  instance.post(`/companies/${companyId}/increment-view`);
...
export const fetchProjects = (username: string) =>
  instance.get(`/companies/${username}/projects`);
export const fetchAllProjects = () => instance.get("/companies/projects");
export const createProject = (
  id: string | number,
  formData: Record<string, any>
) =>
  instance.post(`/companies/${id}/projects`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
export const updateProject = (
  ...
  instance.put(`/companies/${id}/projects/${projectId}`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
export const deleteProject = (
  id: string | number,
  projectId: string | number
) => instance.delete(`/companies/${id}/projects/${projectId}`);
